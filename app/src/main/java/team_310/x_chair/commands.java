...
class commands {
    ...
    */
    ...
    ////////2 Byte Commands///////////////
    static final String BB_SPEED_SETTING = "0x83";
    static final String BB_LEFT_WHEEL_POWER = "0x84";
    static final String BB_RIGHT_WHEEL_POWER = "0x85";


    ////////VEHICLE TO CLIENT/////////////
    static final String VtoC_RESET = "0x81";
    static final String VtoC_BATTERY_VOLTAGE = "0x82";
    static final String VtoC_SPEED_SETTING = "0x83";
    static final String VtoC_ACTUAL_SPEED = "0x86";
